...
class Menu extends Container {
    constructor(events: Events, args = {}) {
        ...
        const helpMenuPanel = new MenuPanel([{
            ...
            icon: 'E232',
            onSelect: () => window.open('https://github.com/YaeSakura923/PointForge/wiki', '_blank')?.focus()
        }, {
            ...
            icon: 'E259',
            onSelect: () => window.open('https://github.com/YaeSakura923/PointForge', '_blank')?.focus()
        }, {
            text: localize('menu.help.log-issue'),
            icon: 'E336',
            onSelect: () => window.open('https://github.com/YaeSakura923/PointForge/issues', '_blank')?.focus()
        }, {
            // separator
        }, {
